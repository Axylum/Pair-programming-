        ...
        */
        ...
        if ( Random.value > 0.5f )
        {
            ...
            else
            {
                ...
                log = "The " + monster.name + " hits the " + hero.name + " for " + monster.damage + " damage! It has " + hero.health + " HP remaining";
            }
        }
        else
        {
            ...
            else
            {
                ...
                log = "The " + hero.name + " hits the " + monster.name + " for " + hero.damage + " damage! It has " + monster.health + " HP remaining";
